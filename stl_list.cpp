...
int main(int argc, char** argv) {
    ...
    list<Employee> emps; //list to hold employees
    ...
    ofstream final("list_solution.csv");
    final << "Employee_ID;Salary;Department";
    list<Employee>::iterator i;
    for (i = emps.begin(); i != emps.end(); ++i) {
        string x1 = i->getId();
        string x2 = i->getSalary();
        string x3 = i->getDepartment();
